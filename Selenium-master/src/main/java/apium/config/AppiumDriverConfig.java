...
public class AppiumDriverConfig {
    ...
    caps.setCapability("chromedriverExecutable","/opt/homebrew/bin/chromedriver");//подключение хромдрайвера через указания путя
    caps.setCapability(MobileCapabilityType.PLATFORM_VERSION, "13.0");//указываем версию Android
